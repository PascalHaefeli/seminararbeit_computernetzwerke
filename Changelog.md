...
Pascal
	...
	To-Do:
		- Passwörter bei den Switches einrichten (habe ich noch nicht gemacht, weil ich es doof finde, die für jede Kleinigkeit eingeben zu müssen)
		- Ethernetchannel zwischen den Switches einrichten
		- Scalability
	...
	Offene Fragen
		an Näthi:
			- Wieso starten die IPs für VLANs 10 und 20 bei .50 statt bei .1?
			- Woher hast du beim DHCP die Max Users? In der Aufgabenstellung steht, dass die Firma ca. 100 Angestellte hat und wachsen können muss, wieso also spezifisch 150 und 100 Adressen für VLANs 10 und 20? Wieso 520 bei den Servern?